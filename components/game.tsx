          ...
          <div className="bg-yellow-100 p-8 rounded-lg border-4 border-yellow-500 shadow-lg max-w-md">
            ...
            <div className="mt-6 p-4 bg-white/90 rounded-lg border-2 border-green-500">
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li className="ml-4">- <span className="font-bold">1</span>: Paper (newspapers, cardboard)</li>
                <li className="ml-4">- <span className="font-bold">2</span>: Glass (bottles, jars)</li>
                <li className="ml-4">- <span className="font-bold">3</span>: Food (organic waste)</li>
                <li className="ml-4">- <span className="font-bold">4</span>: General (non-recyclable items)</li>
